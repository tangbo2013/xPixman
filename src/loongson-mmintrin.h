...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_set_pi16 (xuint16_t __w3, xuint16_t __w2, xuint16_t __w1, xuint16_t __w0)
{
	...
	{
		xuint64_t val = ((xuint64_t)__w3 << 48)
			     | ((xuint64_t)__w2 << 32)
			     | ((xuint64_t)__w1 << 16)
			     | ((xuint64_t)__w0 <<  0);
		return *(__m64 *)&val;
	...
	else if (__w3 == __w2 && __w2 == __w1 && __w1 == __w0)
	{
		...
		xuint64_t val = __w3;
		xuint64_t imm = _MM_SHUFFLE (0, 0, 0, 0);
		__m64 ret;
		asm("pshufh %0, %1, %2\n\t"
		    : "=f" (ret)
...
_mm_set_pi32 (unsigned __i1, unsigned __i0)
{
	...
	{
		xuint64_t val = ((xuint64_t)__i1 << 32)
			     | ((xuint64_t)__i0 <<  0);
		return *(__m64 *)&val;
	}
	else if (__i1 == __i0)
	{
		xuint64_t imm = _MM_SHUFFLE (1, 0, 1, 0);
		__m64 ret;
		asm("pshufh %0, %1, %2\n\t"
		    : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_shuffle_pi16 (__m64 __m, xint64_t __n)
{
	__m64 ret;
	asm("pshufh %0, %1, %2\n\t"
	    : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_slli_pi16 (__m64 __m, xint64_t __count)
{
	__m64 ret;
	asm("psllh  %0, %1, %2\n\t"
	   : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_slli_si64 (__m64 __m, xint64_t __count)
{
	__m64 ret;
	asm("dsll  %0, %1, %2\n\t"
	   : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_srli_pi16 (__m64 __m, xint64_t __count)
{
	__m64 ret;
	asm("psrlh %0, %1, %2\n\t"
	   : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_srli_pi32 (__m64 __m, xint64_t __count)
{
	__m64 ret;
	asm("psrlw %0, %1, %2\n\t"
	   : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
_mm_srli_si64 (__m64 __m, xint64_t __count)
{
	__m64 ret;
	asm("dsrl  %0, %1, %2\n\t"
	   : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
loongson_extract_pi16 (__m64 __m, xint64_t __pos)
{
	__m64 ret;
	asm("pextrh %0, %1, %2\n\t"
	   : "=f" (ret)
...
extern __inline __m64 __attribute__((__gnu_inline__, __always_inline__, __artificial__))
loongson_insert_pi16 (__m64 __m1, __m64 __m2, xint64_t __pos)
{
	__m64 ret;
	asm("pinsrh_%3 %0, %1, %2\n\t"
	   : "=f" (ret)
